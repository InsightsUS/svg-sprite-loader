(function (global, factory) {
  ...
  const deepmerge = createCommonjsModule((module, exports) => {
 ...
 */
  ...
  const namespaces_1 = createCommonjsModule((module, exports) => {
    const namespaces = {
      svg: {
        name: 'xmlns',
 ...
 */
  Sprite.prototype.find = function find(id) {
    return this.symbols.filter((s) => { return s.id === id; })[0] || null;
  };
 ...
 */
  Sprite.prototype.stringify = function stringify() {
    ...
    const stringifiedSymbols = this.symbols.map((s) => { return s.stringify(); }).join('');
 ...
 */
  ...
  Sprite.prototype.destroy = function destroy() {
    this.symbols.forEach((s) => { return s.destroy(); });
  };
 ...
 */
  ...
  SpriteSymbol.prototype.destroy = function destroy() {
    ...
    ['id', 'viewBox', 'content'].forEach((prop) => { return delete this$1[prop]; });
  };
 ...
 */
  ...
  const attSelector = attList.map((attr) => { return (`[${attr}]`); }).join(',');
 ...
 */
  const updateUrls = function (svg, references, startsWith, replaceWith) {
    ...
    const attrs = selectAttributes(nodes, (ref) => {
    ...
    attrs.forEach((attr) => { return attr.value = attr.value.replace(new RegExp(escapeRegExp(startsWithEncoded), 'g'), replaceWithEncoded); });
 ...
 */
  ...
  const BrowserSprite = (function (Sprite$$1) {
    function BrowserSprite(cfg) {
      ...
      if (config.syncUrlsWithBaseTag) {
        ...
        emitter.on(Events.MOUNT, () => { return this$1.updateUrls('#', baseUrl); });
      }
   ...
   */
    ...
    BrowserSprite.prototype.destroy = function destroy() {
      ...
      symbols.forEach((s) => { return s.destroy(); });
  ...
  const ready$1 = createCommonjsModule((module) => {
/*!
